            ...
            <table id="mytable" class="exportable"  border="1" style="width:100%;">
                  ...
                  if($submit_date==7){
                    if(empty($datestart) && empty($dateend)){
                      ...
                      $sql_pre = "SELECT * FROM import_details WHERE `date_import` >= '$datestart' ORDER BY date_import DESC LIMIT $startIndex, $recordsPerPage";
                      ...
                      $sql_pre = "SELECT * FROM import_details WHERE `date_import` <= '$dateend' ORDER BY date_import DESC LIMIT $startIndex, $recordsPerPage";
                      ...
                      $sql_pre = "SELECT * FROM import_details WHERE `date_import` BETWEEN '$datestart' AND '$dateend' ORDER BY date_import DESC LIMIT $startIndex, $recordsPerPage";
