...
<html>
  ...
  <body>
    ...
    <div class="container my-4" style="max-width: 100%;">
      ...
      <center>
        <p class="h3">DANH SÁCH NHẬP HÀNG</p>
        <?php 
            ...
            <table id="mytable" class="exportable"  border="1" style="width:100%;">
                  ...
                  if($submit_date==7){
                    if(empty($datestart) && empty($dateend)){
                      ...
                      $sql_pre = "SELECT * FROM billing WHERE `date_billing` <= '$dateend' ORDER BY date_created DESC LIMIT $startIndex, $recordsPerPage";
                      ...
                      $sql_pre = "SELECT * FROM billing WHERE `date_billing` BETWEEN '$datestart' AND '$dateend' ORDER BY date_created DESC LIMIT $startIndex, $recordsPerPage";
