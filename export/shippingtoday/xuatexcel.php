            ...
            <table id="mytableEx" class="exportable"  border="1" style="width:100%;">
                  ...
                  if($submit_date==7){
                    if(empty($datestart) && empty($dateend)){
                      ...
                      $query = "SELECT COUNT(*) as total_records FROM billing WHERE `date_billing` >= '$datestart'";
                      $result = mysqli_query($con, $query);
                      $row = mysqli_fetch_assoc($result);
                      $totalRecords = $row['total_records'];
                      $recordsPerPage = 20;
                      ...
                      $sql_pre = "SELECT * FROM billing WHERE `date_billing` >= '$datestart' ORDER BY date_shipping DESC ";
                      
                    }elseif($datestart==="" && $dateend !==""){
                      $query = "SELECT COUNT(*) as total_records FROM billing WHERE `date_billing` <= '$dateend'";
                      $result = mysqli_query($con, $query);
                      $row = mysqli_fetch_assoc($result);
                      $totalRecords = $row['total_records'];
                      $recordsPerPage = 20;
                      ...
                      $sql_pre = "SELECT * FROM billing WHERE `date_billing` <= '$dateend' ORDER BY date_shipping DESC ";
                      
                    }else{
                      $query = "SELECT COUNT(*) as total_records FROM billing WHERE `date_billing` BETWEEN '$datestart' AND '$dateend'";
                      $result = mysqli_query($con, $query);
                      $row = mysqli_fetch_assoc($result);
                      $totalRecords = $row['total_records'];
                      $recordsPerPage = 20;
                      ...
                      $sql_pre = "SELECT * FROM billing WHERE `date_billing` BETWEEN '$datestart' AND '$dateend' ORDER BY date_shipping DESC ";
