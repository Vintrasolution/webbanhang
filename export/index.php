    ...
    <div class="container my-4">
      ...
      <div class="card my-4 shadow">
        <div class="card-body">
          ...
          <!-- Thông tin trại --> 
          <form onsubmit="return validateForm()" action="preview.php" method="post" name="myForm" enctype="multipart/form-data">
            <!-- Ngày sử dụng toa thuốc -->
            <label for="field" class="font-weight-bold">Ngày Nhận Đơn:</label> 
            <p><input name="date_use" class="form-control" value="<?php echo date("d/m/Y"); ?>"></p>
            ...
            <p><input type="number" name="phone_receiver" id="phone_receiver" style="width:50%" placeholder="Số Điện Thoại"><input type="text" name="fullname_receiver" id="fullname_receiver" style="width:50%" placeholder="Họ và Tên"></p>
            ...
            <label for="image_upload" class="font-weight-bold">Tải Lên Hình Ảnh Sản Phẩm:</label>
            <p>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.success) {
                        ...
                        $('#fullname_receiver').val(response.data.fullname);
                        $('#phone_receiver').val(response.data.phone);
