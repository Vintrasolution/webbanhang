        ...
        <div class="card-body">
          ...
          <form action="" method="post">
            ...
            <div class="clearfix mt-4" style="text-align: center;">
              <?php if($levelid==4){ if($approval==7){?>
              <button  type="submit" name="submit" value="4" class="btn btn-primary float-center text-uppercase shadow-sm" >ĐỒNG Ý</button>
              <button style="margin-left: 30px;" type="submit" name="submit" value="3" class="btn btn-primary float-center text-uppercase shadow-sm" >TỪ CHỐI</button>
              <?php }else{?>
