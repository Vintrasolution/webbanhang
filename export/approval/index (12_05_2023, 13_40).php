...
<html>
  ...
  <body>
    ...
    <div class="container my-4">
      ...
      <center><p class="h1">PHÊ DUYỆT</p></center>
        ...
        <div class="card-body">
          ...
          <form action="" method="post">
            ...
            <div class="clearfix mt-4" style="text-align: center;">
              <?php if($levelid==4){ if($approval==1){?>
...
<?php 
            ...
            foreach ($run_pre_details as $row_pre_details) {
              ...
              $id_staff = $row_staff['id'];
                if($unit_check=="Chai"||$unit_check=="Lọ"||$unit_check=="Thùng"||$unit_check=="Can"||$unit_check=="Bao"||$unit_check=="Phuy"||$unit_check=="Gói"||$unit_check=="Ống"){
            ...
            $to = $email;
            //TÌM MAIL THỦ KHO
            $sql_thukho = "SELECT * FROM staff as s , user as u WHERE u.level = 5 and s.id = u.id_staff and s.id_farm LIKE '$farm';";
            ...
            $mail->addAddress($to, 'Admin Trại');
            $mail->addAddress($mailthukho);
            $mail->addAddress($mailcreate);
            $mail->addAddress($email_vinh);
