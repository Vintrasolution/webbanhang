                  ...
                  if($level ==1 ){
                    $sql_debt = "SELECT * FROM debt ORDER BY date_create DESC";
                      ...
                      if($level==5||$level==4||$level==6){
                        $sql_debt = "SELECT * FROM debt WHERE id_farm ='$id_farm' ORDER BY date_create DESC";
                      } else{
                        $sql_debt = "SELECT * FROM debt WHERE `status` =1 AND `id_staff`='$id_staff' AND `id_farm` ='$id_farm' ORDER BY date_create DESC";
                      }
                  }
