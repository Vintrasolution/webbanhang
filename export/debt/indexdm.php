...
<html>
  ...
  <body>
    ...
    <div class="container my-4">
      ...
      <center><p class="h1">DANH SÁCH TẠM GIỮ CHAI</p></center>
      <?php 
        $ok = $_GET['success'];
        if($ok==1){
          ...
          <form action="filter.php" method="POST">
            ...
            <table border="1" style="width:100%;">
                      <tr>
                        ...
                        <!--<th >Trạng Thái</th>-->
                        <th >Ngày</th>
                        <?php $level = $row['level']; if($level ==2){ ?>
                        <th >Công Cụ</th>
                      <?php } ?>
                      </tr>
                  ...
                  foreach ($run_debt as $row_debt) {
                      ...
                      if($level ==5){
                      echo "<td> <a style='text-decoration:none' href='chitiet.php/?id=".$id_debt."'>THU</a> </td>";
                      }
                      echo "</tr>";
