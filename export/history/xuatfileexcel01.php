                  ...
                  if($submit_date==7){
                    ...
                    if($producttype !=""){
                      if(empty($datestart) && empty($dateend)){
                        ...
                        $sql_pre = "SELECT * FROM billing LEFT JOIN billing_product_type ON billing.id = billing_product_type.id_billing WHERE billing_product_type.id_product_type='$producttype' ORDER BY billing.date_shipping DESC, billing.time_shipping DESC";
                        ...
                        $sql_pre = "SELECT * FROM billing LEFT JOIN billing_product_type ON billing.id = billing_product_type.id_billing WHERE billing_product_type.id_product_type='$producttype' AND `date_shipping` >= '$datestart' ORDER BY date_shipping DESC";
                        ...
                        $sql_pre = "SELECT * FROM billing LEFT JOIN billing_product_type ON billing.id = billing_product_type.id_billing WHERE billing_product_type.id_product_type='$producttype' AND `date_shipping` <= '$dateend' ORDER BY date_shipping DESC";
                        ...
                        $sql_pre = "SELECT * FROM billing LEFT JOIN billing_product_type ON billing.id = billing_product_type.id_billing WHERE billing_product_type.id_product_type='$producttype' AND `date_shipping` BETWEEN '$datestart' AND '$dateend' ORDER BY date_shipping DESC";
                      ...
                      $sql_pre = "SELECT * FROM billing ORDER BY date_shipping DESC";
                      ...
                      $sql_pre = "SELECT * FROM billing WHERE `date_shipping` >= '$datestart' ORDER BY date_shipping DESC";
                      ...
                      $sql_pre = "SELECT * FROM billing WHERE `date_shipping` <= '$dateend' ORDER BY date_shipping DESC";
                      ...
                      $sql_pre = "SELECT * FROM billing WHERE `date_shipping` BETWEEN '$datestart' AND '$dateend' ORDER BY date_shipping DESC";
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
  ...
  <script>
    ...
    function exportExcelFile(workbook) {
      ...
      var fileName = "DanhSachDon_" + year + "-" + month + "-" + day + ".xlsx";
