...
<html>
  ...
  <body>
    ...
    function printForm() {
        ...
        printDocument.open();
        printDocument.write('<html><head>' + styles + '<div style="font-size:12px"><strong>Công Ty TNHH Thương Mại Dịch Vụ Minh Lan Florist</strong><br/>Địa chỉ: 568/5/4 Lạc Long Quân, Phường 5,<br/> Quận 11, Thành phố Hồ Chí Minh</br>MST: 0317315062<br/></div><center><img src="https://banhang.lillyflower.com.vn/admin/img/logo.png" width=200px"><h2 style="font-size:28px">Biên Nhận</h2></center></head><body>');
        ...
        printDocument.body.innerHTML += '<div style="font-size: 13px;"><center>'+formContent+'</center>';
