    ...
    <div class="container my-4">
      ...
      <?php
          $error = $_GET['error'];
            ...
            if($alert ==1){
              echo "<center><a style='color:green'>Cập nhập dữ liệu thành công!</a></center>";
            }
      ?>
      <div class="card my-4 shadow">
        <div class="card-body">
          ...
          <form onsubmit="return validateForm()" action="" method="post" name="myForm">
            ...
            <p><input type="number" name="phone_customer" style="width: 50%;"placeholder="Số Điện Thoại"  value="<?php echo "0".$phone_customer; ?>"><input type="text" name="fullname_customer" style="width: 50%;" placeholder="Họ và Tên" value="<?php echo $fullname_customer; ?>"></p>
            <label for="field" class="font-weight-bold">Người Nhận Hoa:<a style="color:red">*</a></label> 
            <p><input type="number" name="phone_receiver" style="width:50%" placeholder="Số Điện Thoại" value="<?php echo "0".$phone_receiver; ?>"><input type="text" name="fullname_receiver" style="width:50%" placeholder="Họ và Tên" value="<?php echo $fullname_receiver; ?>"></p>
            ...
            <div>
                <select class="form-select form-select-sm mb-3" id="city" name="city_receiver" aria-label=".form-select-sm" style="width:20%; height: 30px;">
                  <option value="<?php echo $city_receiver; ?>" selected><?php echo $city_receiver; ?></option>           
                </select>
                ...
                <select class="form-select form-select-sm mb-3" id="district" name="district_receiver" aria-label=".form-select-sm" style="width:19.5%; height: 30px;">
                  <option value="<?php echo $district_receiver; ?>" selected><?php echo $district_receiver; ?></option>
                </select>

                <select class="form-select" id="ward" aria-label=".form-select-sm" style="width:19.5%; height: 30px;" name="ward_receiver">
                  <option value="<?php echo $ward_receiver; ?>" selected><?php echo $ward_receiver; ?></option>
                </select>
                <input type="text" name="address_receiver" placeholder="Địa chỉ" style="width:19.5%" value="<?php echo $address_receiver; ?>"><input type="text" name="street_receiver"  placeholder="Tên Đường" style="width:20%" value="<?php echo $street_receiver; ?>">
             </div>  
...
<script>
  ...
  <?php 
      ...
      if( $submit_xn ==5){
        ...
        ?><meta http-equiv="refresh" content="0;url=edit.php/?id=<?php echo $id_bill_xn; ?>&alert=1"><?php
      }
      if($submit_xn ==6){
