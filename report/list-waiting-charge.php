...
<head>
  ...
  <title>DANH SÁCH ĐƠN "CHỜ THANH TOÁN"- LILLY FLOWER</title>
...
<html>
  <head>
    <title>DANH SÁCH ĐƠN "CHỜ THANH TOÁN"</title>
  ...
  <body>
    ...
    <div class="container my-4" style="max-width: 100%;">
      ...
      <center>
        <p class="h3">DANH SÁCH ĐƠN "CHỜ THANH TOÁN"</p>
        <?php 
          ...
          <form action="" method="post">
            ...
            <table id="mytable" class="exportable"  border="1" style="width:100%;">
                  ...
                  //$result = mysqli_query($connection, $query);
                        ...
                        $query = "SELECT COUNT(*) as total_records FROM billing LEFT JOIN billing_product_type ON billing.id = billing_product_type.id_billing WHERE billing.pay_status='2';";
                        //echo $query;
                  ...
                  if(empty($datestart) && empty($dateend) && empty($producttype)){
                    //Phân Trang
                    $query = "SELECT COUNT(*) as total_records FROM billing WHERE pay_status='2'";
                    $result = mysqli_query($con, $query);
                    $row = mysqli_fetch_assoc($result);
                    $totalRecords = $row['total_records'];
                    $recordsPerPage = 20;
                    ...
                    $sql_pre = "SELECT * FROM billing WHERE pay_status='2' ORDER BY date_shipping DESC LIMIT $startIndex, $recordsPerPage";
                  }
                  //echo $sql_pre;
                  //echo $query;  
