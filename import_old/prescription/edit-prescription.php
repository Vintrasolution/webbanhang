...
<head>
  ...
  <title>Điều Chỉnh Toa Thuốc - Anova Farm</title>
...
<html>
  <head>
    <title>Điều Chỉnh Toa Thuốc</title>
  ...
  <body>
    ...
    <div class="container my-4">
      ...
      <center><p class="h1">Điều Chỉnh Toa Thuốc</p></center>
      <div class="card my-4 shadow">
        <div class="card-body">
          <!-- Lấy dữ liệu Trại-->
          <?php 
            $id_toa = $_GET['id'];
            $sql_farm_place = "SELECT * FROM prescription_farm_place WHERE id_prescription = '$id_toa'";
