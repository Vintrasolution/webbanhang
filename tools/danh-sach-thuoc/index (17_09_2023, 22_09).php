...
//GET Medicines
	...
	if($levelid !=1){
		$sql = "SELECT * FROM warehouse WHERE `id_farm` LIKE '$id_farm' ORDER BY id_farm ASC";
	}else{
		$sql = "SELECT * FROM warehouse WHERE `id_farm` NOT LIKE '081' AND `id_medicine` NOT LIKE '0' ORDER BY id_farm ASC";
	}
